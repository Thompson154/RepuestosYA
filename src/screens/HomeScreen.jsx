  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.topSection}>
        ...
        {/* Categoría (dentro de la parte guinda) */}
        <Text style={styles.sectionTitleWhite}>Categoría</Text>
      </View>

      {/* Parte inferior en color crema */}
...
const styles = StyleSheet.create({
  container: { flex: 1, 
    backgroundColor: '#F8F4C4' }, // Fondo crema general
  topSection: {
    backgroundColor: '#7E1C13',// Mitad superior guindo
    paddingBottom: 10,
